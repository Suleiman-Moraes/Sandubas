...
/**
 * @author thiago
 * @version v1.0.0 28/12/2016
 * @since v1.0.0
 */
public class CNPJUtil {
   
   public static boolean isValid(String cnpj) {
      if (Assert.isEmpty(cnpj)) return false;
   ...
   public static String unmask(String cnpj) {
      return Assert.isNotEmpty(cnpj) ? cnpj.replaceAll("[./-]", "") : "";
   }
   
   public static String mask(String cnpj) {
      return Assert.isNotEmpty(cnpj) ? cnpj.replaceAll("(\\d{2})(\\d{3})(\\d{3})(\\d{4})(\\d{2})", "$1.$2.$3/$4-$5") : "";
   }
